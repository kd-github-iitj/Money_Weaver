      ...
      <div className="p-8 space-y-8">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-3">
            <Button className="bg-pink-500 hover:bg-pink-600 text-white rounded-xl px-6 py-2 text-sm font-medium">
              <span className="flex items-center gap-2">
                ✓ Certification <span className="bg-pink-400 text-xs px-2 py-1 rounded-full">Set</span>
              </span>
            </Button>
            <Button className="bg-blue-500 hover:bg-blue-600 text-white rounded-xl px-6 py-2 text-sm font-medium">
              <span className="flex items-center gap-2">
                ↗ Upload a product <span className="bg-blue-400 text-xs px-2 py-1 rounded-full">5/6</span>
              </span>
            </Button>
            <Button className="bg-purple-500 hover:bg-purple-600 text-white rounded-xl px-6 py-2 text-sm font-medium">
              <span className="flex items-center gap-2">
